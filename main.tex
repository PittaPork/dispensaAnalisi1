...
\section{Limiti di funzioni}
    \begin{defi}{Intorno}{}
        ...
        \end{itemize}
    \end{defi}
    \begin{defi}{Definizione di limite}{}
        $f: \text{dom}f \rightarrow\mathbb{R}, \quad\text{dom}f\subseteq\mathbb{R},\quad x_0\in\mathbb{\bar{R}}$\quad è di acc. a dom$f$,\quad$l\in\mathbb{\bar{R}}$\\
        Si dice che $f$ ha limite $l$ per $x\rightarrow x_0$ e si scrive:
            \[\lim_{x\rightarrow x_0}f(x)=l \qquad\text{(oppure $f(x)\rightarrow l$ per $x\rightarrow x_0$)}\]
    \end{defi}
